...
export const endingSets = {
 'cinder-prime':[
  ...
  {id:'offer',title:'The Offer',summary:'Accept a funded internal investigation role. Preserve the client evidence, but keep the public waiting.',
   openingStrong:'Cinder accepts the funded role under client evidence-retention terms. The investigation continues with resources, but independence becomes a daily negotiation.',
   openingWeak:'Cinder accepts the offer with unresolved gaps in the case. Halcyon controls the timetable, and the clients insist on another independent review.',
   closing:'Iva stays at Cinder to protect the evidence archive. Her trust is conditional: client records cannot become bargaining chips.'},
 ...
 'cinder-shadow':[
  {id:'rotate-and-disclose',title:'Full Disclosure',summary:'Rotate every credential in the chain and notify the regulator and customers on schedule.',
   ...
   closing:'Iva files the case chain alongside Cinder\'s other unresolved Halcyon-linked leads. The relay path is closed; who built it is still an open question.'},
